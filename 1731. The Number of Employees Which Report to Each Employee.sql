...
Question Link: https://leetcode.com/problems/the-number-of-employees-which-report-to-each-employee/description/

SELECT m.employee_id, m.name, 
       COUNT(e.employee_id) AS reports_count,
       ROUND(AVG(CAST(e.age AS DECIMAL(10,2))), 0) AS average_age
FROM employees e
